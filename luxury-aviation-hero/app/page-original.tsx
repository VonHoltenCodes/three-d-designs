...
function Boeing737() {
  ...
  try {
    ...
    const clonedScene = useMemo(() => {
      ...
      console.log('Boeing 737 loaded successfully', cloned)
    ...
    console.error('Failed to load Boeing 737:', error)
...
function AviationScene() {
  return (
    <>
      ...
      {/* Aircraft rendered last (foreground) with higher render order */}
      <group position={[0, 0, 0]} renderOrder={1}>
        <Suspense fallback={
          <group>
            <PlaceholderAircraft />
            <mesh position={[0, -8, 0]}>
              <textGeometry args={['Loading Boeing 737...', { size: 1, height: 0.1 }]} />
    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute top-8 right-8 pointer-events-none text-right">
        <div className="text-white">
          ...
          <p className="text-lg md:text-xl font-light opacity-90 mb-6 drop-shadow-lg">
